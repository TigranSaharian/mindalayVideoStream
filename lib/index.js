...
export class RtcConnection{
    ...
    InitConnection(options){
                ...
                if(options.isVideo){
                    if (this.connection.DetectRTC.hasWebcam === true) {
                        ...
                        if(options.videoWidth && options.videoHeight){
                            this.ratio = options.videoWidth / options.videoHeight;
                        }else{
                            this.ratio = MIN_WIDTH / MIN_HEIGHT;
                        }
                        setStreamQuality(MIN_WIDTH, options.videoWidth, MIN_HEIGHT, options.videoHeight, MIN_FRAME_RATE, options.frameRate, this.ratio);
                    }else{
        ...
        var onStopped = function onStopped(){
            ...
            if(!options.isScreenShare) this.connection.closeSocket();
        }
