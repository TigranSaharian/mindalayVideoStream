...
import { getHTMLMediaElement } from '../dev/_getHTMLMediaElement';
...
export class RtcConnection{
    ...
    InitConnection(options){
            ...
            connection.DetectRTC.load(function () {
                ...
                if(options.isVideo){
                    if (connection.DetectRTC.hasWebcam === true) {
                        ...
                        if(options.videoWidth && options.videoHeight) ratio = options.videoWidth / options.videoHeight;
                        else ratio = MIN_WIDTH / MIN_HEIGHT;
                        setStreamQuality(MIN_WIDTH, options.videoWidth, MIN_HEIGHT, options.videoHeight, MIN_FRAME_RATE, options.frameRate, ratio);
                    }else{
            ...
            if(options.isVideo){
                ...
                if(event.type === 'local'){
                    localMediaElement = getHTMLMediaElement(video, {
                        ...
                        width: options.width,
                        container: options.videosContainer,
                        onMuted: onMuted,
                        onUnMuted: onUnMuted,
                        onStopped: onStopped
                    });
        ...
        var onStopped = function onStopped(){
