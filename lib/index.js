...
import {} from '../dev/getHTMLMediaElement';

var connection = null;

function __InitConnection(options){
...
const ___InitConnection = __InitConnection;
export { ___InitConnection as __InitConnection };
const ___openOrJoin = __openOrJoin;
export { ___openOrJoin as __openOrJoin };